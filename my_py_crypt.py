...
arg_token = "token"
arg_token_help = "key file to use if cmd=ek|dk, password to use if cmd=ep|dp. Password will be asked as input if not provided"
...
if cmd = "ek":
    ...
    print("impl password based enc")
elif cmd = "dp":
    print("impl password based dec")
else
